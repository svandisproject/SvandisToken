...
* to inherited SvandisBaseToken behavior
*/
contract SvandisToken is SvandisBaseToken, Pausable, Lockable, Whitelist {
    using SafeMath for uint256;

    /** Events */

    constructor (address _balances, address _allowances, string _name, uint8 _decimals, string _symbol) public 
    SvandisBaseToken(_balances, _allowances, _name, _decimals, _symbol) {}
